...
public class BreakEvenPoint2
{
   public static void main(String[] args)
   {
      ...
      if(breakEvenPoint>0)
      {
         System.out.println("Es müssen mindesten " + breakEvenPoint + " Stück produziert werden.");
      }
      else
      {
         System.out.println("Dieses Produkt ist in dieser Stueckzahl nicht rentabel zu produzieren ");
      }
   }
}  